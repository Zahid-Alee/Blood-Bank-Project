<footer class="text-center text-lg-start bg-white text-muted" style="background-color:#fff5f5 !important">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3 text-secondary"></i>Blood Bank Management
          </h6>
          <p>
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Donor Management</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Reciepent Management</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Inventory Management</a>
          </p>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Donors</a>
          </p>
          <p>
