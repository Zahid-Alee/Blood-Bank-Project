			...
			<div class="col-md-6 col-lg-4">
				<div class="single-service">
					<div class="part-1">
						...
						<h3 class="title" style="font-family:poppins;">Donor Management </h3>
					</div>
					<div class="part-2">
						<p class="description">Express delivery inno service effective logistics solution for delivery
							of small cargo delivery service.</p>
						<a href="#" class='text-dark'><i class="fas fa-arrow-circle-right"></i>Read More</a>
					</div>
				</div>
			</div>
			<!-- / End Single Service -->
			...
			<div class="col-md-6 col-lg-4">
				<div class="single-service">
					<div class="part-1">
						...
						<h3 class="title" style="font-family:poppins;">Reciepent Management</h3>
					</div>
					<div class="part-2">
						<p class="description">Express delivery inno service effective logistics solution for delivery
							of small cargo delivery service.</p>
			...
			<div class="col-md-6 col-lg-4">
				<div class="single-service">
					<div class="part-1">
						...
						<h3 class="title" style="font-family:poppins;">Inventory Management</h3>
					</div>
					<div class="part-2">
						<p class="description">Express delivery inno service effective logistics solution for delivery
							of small cargo delivery service.</p>
